/**
 * MongoDB Script: Fix User Duplicate Records
 *
 * Problem: User collection has duplicate records with same userId+tenantId
 * Cause: Incorrect unique indexes (userId unique globally instead of per tenant)
 *
 * This script will:
 * 1. Find and remove duplicate User records
 * 2. Drop old incorrect unique indexes
 * 3. Create new compound unique indexes for multi-tenancy
 *
 * Run this script in MongoDB shell or MongoDB Compass
 */

// Connect to your database
use crm;  // Change to your database name
...
print("\nIf you see the error again, run this script one more time.");
print("=".repeat(80));
