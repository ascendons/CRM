...
public class AttendanceReportService extends BaseTenantService {
     ...
     */
    @Cacheable(value = "dailyAttendance", key = "T(com.ultron.backend.multitenancy.TenantContext).getTenantId() + '_' + #date")
     ...
     */
    @Cacheable(value = "monthlyReport", key = "T(com.ultron.backend.multitenancy.TenantContext).getTenantId() + '_' + #userId + '_' + #year + '_' + #month")
