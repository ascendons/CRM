...
import { Activity, Search, Filter, Clock, Monitor, Globe } from "lucide-react";
...
export default function UserActivityPage() {
  ...
  const getIcon = (type: ActionType) => {
    switch (type) {
      ...
      case ActionType.LOGIN:
        return <Globe className="w-4 h-4" />; // Or User icon
      default:
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex gap-4">
                  <div
                    className={`mt-1 w-10 h-10 rounded-full flex items-center justify-center border ${getActionColor(activity.actionType)}`}
                  >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-4 mt-2 text-xs text-slate-400">
                      ...
                      {activity.requestUrl && (
                        <span className="max-w-xs truncate" title={activity.requestUrl}>
                          URL: {activity.requestUrl}
                        </span>
                      )}
                    </div>
                  </div>
