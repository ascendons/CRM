...
import { ServiceRequestSource, ServiceRequestStatus, Asset } from "@/types/field-service";
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {Object.values(ServiceRequestSource).map((source) => (
                      ...
                      >
                        ...
                        {source === ServiceRequestSource.WHATSAPP && (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-slate-400 font-medium">
                        Identify the customer and specific equipment.
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
            ...
            <div className="space-y-10">
              ...
              <div className="p-8 bg-indigo-50/50 rounded-[2.5rem] border-2 border-indigo-100 flex items-start gap-4">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-black text-indigo-900 uppercase italic tracking-tight">
                    Audit Visibility
                  </p>
                  <p className="text-[11px] text-indigo-700 font-medium leading-relaxed opacity-80">
                    This entry is permanent. All subsequent work orders and communications will be
                    linked to this unique ticket identifier.
                  </p>
                </div>
              </div>
            </div>
