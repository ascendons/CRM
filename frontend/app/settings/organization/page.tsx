    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        {activeTab === "profile" && organization && (
          <OrganizationProfile organization={organization} onUpdate={loadOrganization} />
        )}
        {activeTab === "settings" && organization && (
          <OrganizationSettingsForm organization={organization} onUpdate={loadOrganization} />
        )}
        {activeTab === "invoice" && organization && (
          <InvoiceSettingsForm organization={organization} onUpdate={loadOrganization} />
        )}
        {activeTab === "usage" && organization && <UsageLimitsComponent />}
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Configure branding and regional preferences</p>
        </div>
        <button
          onClick={handleSave}
          disabled={isSaving}
