          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            {activeTab === "notifications" && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div
                    className="flex items-start gap-4 p-4 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors cursor-pointer"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500">
                        Get real-time updates on your desktop.
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            <div className="flex-shrink-0">
                              <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center border ${
                                  activity.actionType === ActionType.CREATE
                                    ? "bg-green-50 text-green-600 border-green-100"
                                    : activity.actionType === ActionType.UPDATE
                                      ? "bg-blue-50 text-blue-600 border-blue-100"
                                      : activity.actionType === ActionType.DELETE
