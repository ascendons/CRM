    ...
    return (
      <div className="flex items-center justify-center bg-slate-50 min-h-[calc(100vh-4rem)]">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-500 font-medium tracking-tight">Initializing contract builder...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 pb-20 font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-5">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-2xl font-black text-slate-900 tracking-tight">Draft Service Contract</h1>
                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">Phase 1: Structure & Assets</p>
              </div>
            </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-12 animate-in fade-in zoom-in duration-500">
              ...
              <Card className="rounded-[32px] border-slate-200 shadow-xl overflow-hidden overflow-visible border-none bg-white p-2">
                <CardHeader className="px-8 pt-8 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                       <CardTitle className="text-xl font-black tracking-tight text-slate-900">Account Selection</CardTitle>
                       <CardDescription className="font-medium text-slate-400">Choose the customer for this service commitment.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardHeader className="px-8 pt-8 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <CardDescription className="font-medium text-slate-400">Define your performance commitments and billing.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
            ...
            <div className="space-y-10">
              ...
              <div className="p-8 bg-blue-50/50 rounded-[32px] border-2 border-blue-100 flex items-start gap-4">
                 ...
                 <div className="space-y-2">
                    <p className="text-sm font-black text-blue-900 uppercase tracking-tighter">Drafting Phase</p>
                    <p className="text-xs text-blue-700 font-medium leading-relaxed">
                       Contracts are created in DRAFT status. You must ACTIVATE the contract after the first payment or authorization is received.
                    </p>
                 </div>
              </div>
            </div>
