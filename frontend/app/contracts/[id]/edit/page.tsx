            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest px-1">
                  Ref: {formData.id?.split("-")[0].toUpperCase()}
                </p>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="font-medium text-slate-400">
                        Customer linkage and linked equipment registry.
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardHeader className="px-8 pt-8 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="font-medium text-slate-400">
                        Modify performance commitments and billing.
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
              ...
              <div className="p-8 bg-blue-50/50 rounded-[32px] border-2 border-blue-100 flex items-start gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-blue-700 font-medium leading-relaxed">
                    Significant changes to billing cycles or SLA terms should be documented in the
                    amendment notes or communicated to the customer.
                  </p>
                </div>
              </div>
            </div>
