  ...
  const getStatusBadge = (status?: ContractStatus) => {
    switch (status) {
      ...
      case ContractStatus.CANCELLED:
        return (
          <Badge className="bg-rose-50 text-rose-700 border-rose-100 font-bold uppercase text-[10px]">
            {status}
          </Badge>
        );
      case ContractStatus.RENEWED:
        return (
          <Badge className="bg-blue-50 text-blue-700 border-blue-100 font-bold uppercase text-[10px]">
            Renewed
          </Badge>
        );
      default:
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="text-center max-w-md bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
          ...
          <p className="text-slate-500 mb-8 font-medium">
            {error || "This contract record might have been archived or deleted."}
          </p>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-black text-slate-900 tracking-tight font-mono uppercase">
          ...
          <div className="lg:col-span-2 space-y-10">
            <Tabs defaultValue="details" className="w-full">
              <TabsList className="bg-white p-1 rounded-[20px] border border-slate-200 shadow-sm h-14 inline-flex w-full md:w-auto">
                <TabsTrigger
                  value="details"
                  className="rounded-2xl px-8 font-black text-xs uppercase tracking-widest data-[state=active]:bg-primary/5 data-[state=active]:text-primary transition-all"
                >
                  Contract Details
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent
                value="details"
                className="mt-8 space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-300 outline-none"
              >
                    ...
                    <CardContent className="p-8 space-y-8">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-lg font-black text-slate-900">
                          {contract.slaConfig?.responseHrs} Hours
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                        ...
                        <span className="text-lg font-black text-slate-900">
                          {contract.slaConfig?.resolutionHrs} Hours
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                        ...
                        <span className="text-lg font-black text-slate-900">
                          {contract.visitFrequencyPerYear} Visits
                        </span>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-sm font-bold text-slate-600">
                            Hourly Breach Penalty
                          </span>
                        </div>
                        <span className="text-lg font-black text-rose-600">
                          ₹{contract.penaltyConfig?.perHourBreachPenalty?.toLocaleString()}
                        </span>
                      </div>
                ...
                <Card className="rounded-[32px] border-slate-200 shadow-sm bg-white overflow-hidden">
                  <CardHeader className="p-8 border-b border-slate-50">
                    <CardTitle className="text-sm font-black uppercase tracking-widest text-slate-400 font-mono">
                      Notes & Special Instructions
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-8 font-medium text-slate-600 leading-relaxed italic bg-slate-50/30">
                    {contract.notes ||
                      "No additional specific operational instructions registered for this contract."}
                  </CardContent>
                </Card>
              </TabsContent>
              ...
              <TabsContent
                value="assets"
                className="mt-8 outline-none animate-in fade-in slide-in-from-bottom-2 duration-300"
              >
                    ...
                    <div className="relative pl-12">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-slate-400">
                          {new Date(contract.startDate).toLocaleDateString()} — SYSTEM
                        </p>
                      </div>
                    </div>
                    <div className="relative pl-12">
          ...
          <div className="space-y-10">
            <Card className="rounded-[40px] border-none bg-slate-900 shadow-2xl p-4 overflow-hidden relative">
              ...
              <CardHeader className="border-b border-white/5 space-y-1 pb-6 pt-6 px-4">
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2 font-mono">
                  Validity Timeline
                </p>
                ...
                {contract.status === ContractStatus.ACTIVE && (
                  <div className="p-6 bg-emerald-500/10 rounded-3xl border border-emerald-500/20 flex flex-col gap-4">
                    ...
                    <p className="text-[11px] text-slate-400 font-medium leading-relaxed">
                      Underwritten by policy {contract.contractNumber}. All parts and labor covered
                      as per AMC norms.
                    </p>
                  </div>
                )}
            ...
            <Card className="rounded-[40px] border-slate-200 shadow-sm bg-white p-2">
              ...
              <CardContent className="p-8">
                <h3 className="text-lg font-black text-slate-900 tracking-tight leading-7 mb-6">
                  {contract.accountName}
                </h3>
                <Button
                  variant="outline"
