...
import { dealersService, CreateDealerRequest } from "@/lib/dealers";
...
export default function NewDealerPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      await dealersService.createDealer(formData);
      showToast.success("Dealer created successfully.");
      router.push("/dealers");
    } catch (err: any) {
      showToast.error(err?.message || "Failed to create dealer.");
    } finally {
      setLoading(false);
    }
  }
