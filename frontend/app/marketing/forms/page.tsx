  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/marketing/forms/new" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm">
      ...
      {forms.length === 0 ? (
        <div className="text-center py-16">
          ...
          <Link href="/marketing/forms/new" className="text-blue-600 text-sm mt-2 inline-block">Create your first form</Link>
        </div>
      ) : (
            ...
            <div key={form.formId} className="bg-white rounded-xl border border-gray-200 p-5">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1">
                  <Link href={`/marketing/forms/${form.formId}/edit`} className="p-1 text-gray-400 hover:text-blue-600">
                    <Edit className="w-4 h-4" />
                  </Link>
                  <button onClick={() => handleDelete(form.formId)} className="p-1 text-gray-400 hover:text-red-600">
              ...
              {form.themeColor && (
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-4 h-4 rounded-full border border-gray-200" style={{ backgroundColor: form.themeColor }} />
                  <span className="text-xs text-gray-400">{form.themeColor}</span>
                </div>
              )}
              <div className="flex gap-2 mt-4">
                <Link href={`/marketing/forms/${form.formId}/submissions`}
                ...
                <Link href={`/marketing/forms/${form.formId}/edit`}
                  className="flex items-center gap-1 text-xs text-gray-600 border border-gray-200 px-3 py-1.5 rounded-lg hover:bg-gray-50">
