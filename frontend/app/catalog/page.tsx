    ...
    return (
        <div className="bg-slate-50">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-5 rounded-xl">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            <h3 className="text-base font-bold text-blue-900 mb-3">📋 Catalog & Inventory Setup Guide</h3>
                            ...
                            <div className="space-y-3 mb-4">
                                <div className="bg-white rounded-lg p-3 border border-blue-100">
                                    ...
                                    <div className="ml-7 space-y-1">
                                        <p className="text-xs text-blue-800">
                                            ...
                                            <code className="ml-1 px-1.5 py-0.5 bg-blue-50 rounded text-xs font-mono">ProductName</code>
                                            <code className="ml-1 px-1.5 py-0.5 bg-blue-50 rounded text-xs font-mono">Unit</code>
                                            <code className="ml-1 px-1.5 py-0.5 bg-blue-50 rounded text-xs font-mono">Description</code>
                                            <code className="ml-1 px-1.5 py-0.5 bg-blue-50 rounded text-xs font-mono">UnitPrice</code>
                                            <code className="ml-1 px-1.5 py-0.5 bg-blue-50 rounded text-xs font-mono">HsnCode</code>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg p-3 border border-indigo-100">
                                    ...
                                    <div className="ml-7 space-y-1">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-xs text-indigo-700 mt-1">
                                            <div>• <code className="px-1.5 py-0.5 bg-indigo-50 rounded font-mono">SKU</code> (auto-generated if empty)</div>
                                            <div>• <code className="px-1.5 py-0.5 bg-indigo-50 rounded font-mono">InitialStock</code> (default: 0)</div>
                                            <div>• <code className="px-1.5 py-0.5 bg-indigo-50 rounded font-mono">Warehouse</code> (code/name, uses default if empty)</div>
                                            <div>• <code className="px-1.5 py-0.5 bg-indigo-50 rounded font-mono">MinStockLevel</code> (default: 10)</div>
                                            <div>• <code className="px-1.5 py-0.5 bg-indigo-50 rounded font-mono">ReorderLevel</code> (default: 20)</div>
                                        </div>
                                        <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded">
                                            <p className="text-xs text-green-800">
                                                <strong>💰 UnitPrice Auto-Mapping:</strong> Your <code className="px-1 py-0.5 bg-white rounded font-mono text-green-700">UnitPrice</code> is automatically mapped to Base Price in inventory - both auto and manual enable!
                                            </p>
                                        </div>
                                        <p className="text-xs text-indigo-600 mt-2 italic">
                                            ✨ If <strong>any</strong> inventory column is present, inventory will be auto-enabled with smart defaults!
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg p-3 border border-green-100">
                                    <p className="text-sm font-semibold text-green-900 mb-2">
                                        <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-green-600 text-white text-xs font-bold mr-2">3</span>
                                        Manual Bulk Enable (After Upload)
                                    </p>
                                    <div className="ml-7">
                                        <p className="text-xs text-green-800">
                                            Select products → Click <strong className="text-green-700">"Enable Inventory"</strong> → Configure → Done!
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table className="text-xs border-collapse w-full">
                                        <thead>
                                            <tr className="bg-slate-100">
                                                <th className="border border-slate-300 px-2 py-1 text-left">ProductName*</th>
                                                ...
                                                <th className="border border-slate-300 px-2 py-1 text-left bg-indigo-50">SKU</th>
                                                <th className="border border-slate-300 px-2 py-1 text-left bg-indigo-50">InitialStock</th>
                                                <th className="border border-slate-300 px-2 py-1 text-left bg-indigo-50">Warehouse</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
            ...
            {selectedIds.size > 0 && (() => {
                ...
                const allNotTracked = Array.from(selectedIds).every(id =>
                    !inventoryStatuses[id]?.inventoryTracked
                );
