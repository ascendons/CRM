                          ...
                          {notifications.map((notification) => (
                            ...
                            >
                              <div className="flex justify-between items-start mb-1">
                                <h4
                                  className={`text-sm font-semibold flex items-center gap-2 ${notification.isRead ? "text-slate-700" : "text-slate-900"}`}
                                >
                                  {!notification.isRead && (
                              ...
                              <p
                                className={`text-sm ${notification.isRead ? "text-slate-500" : "text-slate-700"}`}
                              >
