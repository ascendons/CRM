    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
        <Card className="max-w-xl w-full rounded-[3rem] border-none shadow-2xl bg-white p-12 text-center animate-in zoom-in-95 duration-500">
           ...
           <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-4 uppercase">Ticket Registered</h2>
           <p className="text-slate-500 font-bold mb-8 text-lg">
             Your complaint has been logged under ID: <span className="text-indigo-600 underline decoration-indigo-200 decoration-4 underline-offset-4">{ticketId}</span>
           </p>
           <div className="bg-slate-50 rounded-3xl p-6 text-sm font-medium text-slate-600 mb-10 leading-relaxed border border-slate-100">
             Our technical team has been notified. You will receive an email confirmation with tracking details shortly.
           </div>
           <Button onClick={() => setSubmitted(false)} variant="outline" className="rounded-2xl h-14 px-10 font-black border-2 border-slate-100">
    ...
    <div className="min-h-screen bg-slate-50/50 font-sans selection:bg-indigo-600 selection:text-white">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 py-6 flex items-center justify-between">
           <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-black text-slate-900 tracking-tighter uppercase italic">Service<span className="text-indigo-600">Portal</span></span>
           </div>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="text-center mb-16">
           <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-4 uppercase italic leading-none">Log a Technical Issue</h1>
           <p className="text-slate-400 font-bold text-lg max-w-lg mx-auto leading-relaxed">Describe the equipment problem you're experiencing and our field force will mobilize in accordance with your SLA.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <CardContent className="p-8 space-y-10">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                       <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Customer Identifier / Account</Label>
                       <Input 
                    ...
                    <div className="space-y-3">
                       <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Equipment Serial No</Label>
                       <Input 
                 ...
                 <div className="space-y-3">
                    <Label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Detailed Description of Defect *</Label>
                    <textarea 
                      required
                      name="description"
                      onChange={handleChange}
                 ...
                 <div className="pt-4">
                    ...
                    >
                       {loading ? <Loader2 className="h-8 w-8 animate-spin" /> : <Send className="h-7 w-7" />}
           ...
           <div className="flex flex-col md:flex-row items-center justify-center gap-12 text-slate-400 pt-6">
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-widest">SLA Protected Channel</span>
              </div>
              <div className="flex items-center gap-3">
                 <Globe className="h-5 w-5 text-indigo-400" />
                 <span className="text-[10px] font-black uppercase tracking-widest">Global Field Dispatch</span>
              </div>
              <div className="flex items-center gap-3">
                 <Calendar className="h-5 w-5 text-slate-300" />
                 <span className="text-[10px] font-black uppercase tracking-widest">24/7 Intake Sync</span>
              </div>
           </div>
        </form>
      </main>
      ...
      <footer className="max-w-4xl mx-auto px-6 py-20 text-center">
         <p className="text-xs font-bold text-slate-300 uppercase tracking-[0.2em] mb-4">Powered by Ultron Field Systems</p>
