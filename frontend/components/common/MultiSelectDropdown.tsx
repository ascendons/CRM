  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center justify-between gap-2 px-4 py-2.5 bg-white border rounded-xl text-sm font-medium transition-all min-w-[200px] ${
          isOpen
      ...
      >
        <span className={selectedValues.length > 0 ? "text-slate-900" : "text-slate-500"}>
          {selectedValues.length > 0 ? `${label}: ${selectedValues.length} selected` : label}
        </span>
        <ChevronDown
