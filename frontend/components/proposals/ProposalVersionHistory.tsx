          ...
          {history.map((version) => (
            <li
              ...
              className={`hover:bg-slate-50/80 transition-all group ${
                selectedForCompare.includes(version.id) ? "bg-primary/5" : ""
              }`}
            >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded-full text-[10px] uppercase font-bold tracking-wider bg-${getActionColor(version.action)}-100 text-${getActionColor(version.action)}-700 border border-${getActionColor(version.action)}-200`}
                      >
                    ...
                    <p className="text-sm text-slate-600 font-medium mb-3">{version.comment}</p>
