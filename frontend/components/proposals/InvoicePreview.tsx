...
const InvoicePreview = forwardRef<HTMLDivElement, InvoicePreviewProps>(
  (
    { proposal, organization, template, parentTaxAmount }: InvoicePreviewProps,
    ...
    return (
      ...
      >
        ...
        <div className="flex justify-between items-center bg-blue-50/30 rounded-xl pb-2 mb-2">
          <div>
            <span className="text-[10px] font-black text-blue-900/40 uppercase tracking-[0.2em] block mb-1">
              Reference Number
            </span>
              ...
              <div className="grid grid-cols-1 gap-1 text-[10px]">
                {proposal.billingAddress?.name && (
                  <p className="flex gap-2">
                    <span className="font-bold text-gray-400 uppercase w-10 underline decoration-blue-100 underline-offset-4">
                      Name
                    </span>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border-l-4 border-blue-900 pl-5 py-2">
              ...
              <div className="grid grid-cols-1 gap-1 text-[10px]">
                ...
                {(proposal.shippingAddress?.phone ||
                  proposal.billingAddress?.phone ||
                ...
                {(proposal.shippingAddress?.email ||
                  proposal.billingAddress?.email ||
                ...
                {(proposal.shippingAddress?.gstNumber ||
                  proposal.billingAddress?.gstNumber ||
                  proposal.gstNumber) && (
                  <p className="flex gap-2">
                    <span className="font-bold text-gray-400 uppercase w-10 underline decoration-blue-100 underline-offset-4">
                      GSTIN
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-4 print:pt-4">
          ...
          <div className="flex-1 space-y-8 print-break-inside-avoid">
            <div className="space-y-3">
              <h3 className="text-[10px] font-black text-blue-900 uppercase tracking-widest underline decoration-blue-900/20 underline-offset-8">
                Payment Terms
              </h3>
              ...
              <div className="space-y-2">
                {invoiceConfig?.bankName ? (
                  <div className="grid grid-cols-2 gap-4 text-[12px]">
                    <div>
                      <p className="text-gray-400 font-bold uppercase tracking-tighter mb-0.5">
                        Bank Name
                      </p>
                    ...
                    <div>
                      ...
                      <p className="font-black text-gray-900 tracking-tight font-mono">
                        {invoiceConfig.accountNumber}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-400 font-bold uppercase tracking-tighter mb-0.5">
                  ...
                  <p className="italic text-gray-400 text-xs">
                    Bank details not available for this organization.
                  </p>
                )}
              </div>
            </div>
                ...
                return (
                  <div className="flex justify-between items-center text-sm">
                    <span className="font-bold text-gray-400 uppercase tracking-widest text-[10px] flex flex-col">
                      Total Tax/GST
                      {proposal.gstType && (
                        <span className="text-[8px] italic normal-case font-medium opacity-50 tracking-normal leading-tight">
                          [{proposal.gstType}]
                        </span>
                      )}
                    </span>
                    <span className="font-black text-gray-900">
                      {formatCurrency(
                        computedTax > 0 ? computedTax : (parentTaxAmount ?? proposal.taxAmount)
                      )}
                    </span>
                  </div>
                );
            ...
            <div className="bg-blue-900 rounded-2xl p-7 shadow-xl shadow-blue-900/10 print-break-inside-avoid">
              <div className="flex justify-between items-center text-white mb-2">
                ...
                <span className="text-2xl font-black tracking-tighter tabular-nums">
                  {formatCurrency(
                    isProforma && proposal.milestonePayableAmount
                      ? proposal.milestonePayableAmount
        ...
        <div className="mt-6 pt-2 border-t border-gray-100 flex justify-between items-center text-[6px] font-black text-gray-500 uppercase tracking-[0.2em]">
          ...
          <span className="italic">
            {invoiceConfig?.footerText || "Thank you for choosing our services."}
          </span>
        </div>
      </div>
    );
