...
const InvoicePreview = forwardRef<HTMLDivElement, InvoicePreviewProps>(({
    ...
    return (
        ...
        >
                ...
                <div className="w-full max-w-[240px] flex flex-col items-center">
                    <div className="w-full flex flex-col items-center space-y-6">
                        ...
                        <div className="text-center">
                            <span className="text-[10px] font-black text-blue-900 uppercase tracking-[0.3em] block mb-1">
            ...
            {/* Page Footer */}
            <div className="mt-12 pt-6 border-t border-gray-100 flex justify-between items-center text-[9px] font-black text-gray-300 uppercase tracking-[0.2em]">
