...
export default function ProposalSnapshotModal({
  version,
  isOpen,
  onClose,
}: ProposalSnapshotModalProps) {
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-10 space-y-10">
                ...
                <dl className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <dd className="text-sm font-bold text-slate-900">
                        {proposal.paymentTerms || "Standard"}
                      </dd>
                    </div>
                  </div>
                </dl>
                ...
                <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-xl shadow-slate-200">
                  <dl className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <dd className="font-bold text-rose-400">
                    ...
                    <div className="pt-4 mt-4 border-t border-white/10 flex justify-between items-end">
                      <dt className="text-xs font-bold text-primary uppercase tracking-tighter">
                        Total Amount
                      </dt>
                      <dd className="text-3xl font-black tracking-tight">
          ...
          {proposal.notes && (
            <section className="bg-amber-50 rounded-2xl p-6 border border-amber-100/50">
              <h3 className="text-[10px] font-black text-amber-600 uppercase tracking-widest mb-2">
