    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Adjust pricing and discounts to reach an agreement.
          </p>
        </div>
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {items.map((item, index) => (
              <tr key={index}>
                ...
                <td className="px-4 py-3 text-right text-sm text-gray-500">{item.taxRate}%</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="border rounded-lg p-4 bg-gray-50">
        <div className="flex items-center mb-3">
          ...
          />
          <label htmlFor="enableDiscount" className="ml-2 text-sm font-medium text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                value={discount.type}
                onChange={(e) =>
                  setDiscount((prev) => ({ ...prev, type: e.target.value as DiscountType }))
                }
