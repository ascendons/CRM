        ...
        {hasActiveFilters && (
          <div className="pt-4 border-t border-slate-100">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {activeFilters.attributes && Object.entries(activeFilters.attributes).map(([key, value]) => (
                <span key={key} className="inline-flex items-center gap-1 px-2 py-1 bg-amber-50 text-amber-700 rounded text-xs">
                  {key}: {value}
                  <button
