...
export default function InvoiceSettingsForm({ organization, onUpdate }: InvoiceSettingsFormProps) {
  ...
  const [formData, setFormData] = useState<InvoiceConfig>({
    ...
    authorizedSignatoryLabel:
      organization.invoiceConfig?.authorizedSignatoryLabel || "Authorized Signatory",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              {formData.authorizedSignatorySealUrl && (
                <div className="mt-2 p-2 bg-white border rounded inline-block">
                  <img
                    src={formData.authorizedSignatorySealUrl}
                    alt="Seal Preview"
