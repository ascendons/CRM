...
export default function ProductForm({
  ...
  const [minStockLevel, setMinStockLevel] = useState<number | undefined>(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              value={listPrice || ""}
              onChange={(e) =>
                setListPrice(e.target.value ? parseFloat(e.target.value) : undefined)
              }
              step="0.01"
              min="0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              value={reorderLevel || ""}
              onChange={(e) =>
                setReorderLevel(e.target.value ? parseInt(e.target.value) : undefined)
              }
              min="0"
              placeholder="Optional"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div>
            ...
            <input
              ...
              value={minStockLevel || ""}
              onChange={(e) =>
                setMinStockLevel(e.target.value ? parseInt(e.target.value) : undefined)
              }
              min="0"
              placeholder="Optional"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div>
            ...
            <input
              ...
              value={maxStockLevel || ""}
              onChange={(e) =>
                setMaxStockLevel(e.target.value ? parseInt(e.target.value) : undefined)
              }
              min="0"
              placeholder="Optional"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
