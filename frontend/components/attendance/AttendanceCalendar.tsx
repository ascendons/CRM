    ...
    <div className="bg-white rounded-xl shadow p-6">
      ...
      <div className="grid grid-cols-7 gap-2">
        {calendarDays.map((day, index) => {
          ...
          const colors = attendance
            ? getStatusColor(attendance.status)
            : { bg: "bg-white", border: "border-gray-200", text: "text-gray-700" };
              ...
              <div className="flex flex-col h-full">
                ...
                {attendance?.workMinutes && (
                  <div className="text-xs text-gray-600 mt-auto">
                    {formatDuration(attendance.workMinutes)}
                  </div>
                )}
              </div>
            </button>
          ...
          {[
            ...
            return (
              <div key={status} className="flex items-center gap-2">
                <div
                  className={`w-8 h-8 border-2 rounded ${colors.bg} ${colors.border} flex items-center justify-center`}
                >
