...
export const performanceApi = {
  ...
  createCycle: (data: any) =>
    apiRequest<any>(`${BASE}/cycles`, { method: "POST", body: JSON.stringify(data) }),
  ...
  createReview: (data: any) =>
    apiRequest<any>(`${BASE}/reviews`, { method: "POST", body: JSON.stringify(data) }),
  submitReview: (id: string) => apiRequest<any>(`${BASE}/reviews/${id}/submit`, { method: "POST" }),
  acknowledgeReview: (id: string) =>
    apiRequest<any>(`${BASE}/reviews/${id}/acknowledge`, { method: "POST" }),
  getObjectives: () => apiRequest<any>("/hr/okrs"),
  createObjective: (data: any) =>
    apiRequest<any>("/hr/okrs", { method: "POST", body: JSON.stringify(data) }),
  updateKeyResult: (id: string, krIndex: number, data: any) =>
    apiRequest<any>(`/hr/okrs/${id}/key-results/${krIndex}`, {
      method: "PUT",
